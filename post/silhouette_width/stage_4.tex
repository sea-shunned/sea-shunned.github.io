...
\begin{scope}[shift={(2.7,4.475)}]
    \node[scale=0.65]{4.~Select the minimum average inter-cluster distance};
\end{scope}
    ...
    \foreach \point [count=\i] in {(2.3,5),(2.7,5.3),(2.8,5.9),(2.65,5.6), (2.1,5.3)} {
        ...
        \begin{scope}[on background layer]
            \draw[white, dashed, line width=0.8pt] (special) -- (\this);
        \end{scope}
    ...
    \foreach \point [count=\i] in {(-0.2,2.8),(-0.5,2.6),(-0.1,2.4)} {
        ...
        \node[coordinate] (\this) at \point {} ;
        \begin{scope}[on background layer]
            \draw[bcolours, line width=1.4pt] (special) -- (\this);
        \end{scope}
        \fill[datapoint] (\this) circle (\circlesize) ;
